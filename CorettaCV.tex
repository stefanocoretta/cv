...
\begin{entrylist}
	\entry{in publication}{The decline of local anchoring: A quantitative investigation. \textnormal{\textit{English Language \& Linguistics}.}. \vspace{0.5em}}
		{}
		{\small Bettelou Los, Dreschler Gea, Ans van Kemenade, Erwin Komen, \underline{Stefano Coretta}}
	\entry{in publication}{Multidimensional signals and analytic flexibility: Estimating degrees of freedom in human speech analyses. \textnormal{\textit{Advances in Methods and Practices in Psychological Science}.}. \vspace{0.5em}}
		{}
...
\begin{entrylist}
	\entry{in press}{Syntactic Microvariation in Albanian Dialects: an atlas with digital data. \textnormal{Academy of Albanological Sciences. Institute of Linguistics and Literature. Tiranë.} \vspace{0.5em}}
		{}
