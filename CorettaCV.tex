...
\begin{minipage}[t]{0.5\textwidth} % 45% of the page width for name
	...
	{\huge Senior Teaching Coordinator (Stats)} % Career or current job title
...
\begin{minipage}[t]{0.5\textwidth} % 27.5% of the page width for the first row of icons
  ...
  \icon{MapMarker}{12}{University of Edinburgh, UK}\\
	\icon{Envelope}{12}{\href{mailto:s.coretta@ed.ac.uk}{s.coretta@ed.ac.uk}}\\
...
\begin{entrylist}
	\entry{2023}{Multidimensional signals and analytic flexibility: Estimating degrees of freedom in human speech analyses. \textnormal{\textit{Advances in Methods and Practices in Psychological Science}. 6(3). DOI: 10.1177/2515245923116256}. \vspace{0.5em}}
		{}
		{\small \underline{Stefano Coretta}, Joseph V. Casillas, ..., Timo Roettger}
	\entry{2023}{The decline of local anchoring: A quantitative investigation. \textnormal{\textit{English Language \& Linguistics}. 27(2). 345--372}. \vspace{0.5em}}
		{}
		{\small Bettelou Los, Dreschler Gea, Ans van Kemenade, Erwin Komen, \underline{Stefano Coretta}}
	\entry{2022}{Northern Tosk Albanian (IPA Illustration). \textnormal{\textit{Journal of the International Phonetic Association}. 1--23. DOI: 10.1017/S0025100322000044}. \vspace{0.5em}}
		{}
		{\small \underline{Stefano Coretta}, Josiane Riverin-Coutlée, Enkeleida Kapia and Stephen Nichols}
	\entry{2021}{Distance vs. time: Acoustic and articulatory consequences of reduced vowel duration in Polish. \textnormal{\textit{Journal of the Acoustical Society of America}. 150(1). 592--607. DOI: 10.1121/10.0005585}. \vspace{0.5em}}
		{}
		{\small Patrycja Strycharczuk, Małgorzata Ćavar, \underline{Stefano Coretta}}
	\entry{2021}{Planting the seed for sound change: Evidence from real-time MRI of velum kinematics in German. \textnormal{\textit{Language}.} 97(2). 333--364. \url{https://muse.jhu.edu/article/794876}. \vspace{0.5em}}
		{}
	...
	\entry{2021}{A cross cultural analysis of early prelinguistic gesture development and its relationship to language development. \textnormal{\textit{Child Development}. 92(1). 273--290. DOI: 10.1111/cdev.13406} \vspace{0.5em}}
		{}
		{\small Thea Cameron--Faulkner, Nivedita Malik, Circle Steele, \underline{Stefano Coretta}, Ludovica Serratrice, Elena Lieven}
	\entry{2020}{Longer vowel duration correlates with greater tongue root advancement at vowel offset: Acoustic and articulatory data from Italian and Polish. \textnormal{\textit{Journal of the Acoustical Society of America}. 147. 245--259. DOI: 10.1121/10.0000556} \vspace{0.5em}}
		{}
		{\small Stefano Coretta}
	\entry{2019}{An exploratory study of voicing-related differences in vowel duration as compensatory temporal adjustment in Italian and Polish. \textnormal{\textit{Glossa: a journal of general linguistics}. 4(1), 125. DOI: 10.5334/gjgl.869} \vspace{0.5em}}
		{}
		{\small Stefano Coretta}
\end{entrylist}
...
\begin{entrylist}
	\entry{2023}{Syntactic Microvariation in Albanian Dialects: An atlas with digital data. \textnormal{Academy of Albanological Sciences. Institute of Linguistics and Literature. Tiranë.} \vspace{0.5em}}
		{}
...
\begin{entrylist}
  \entry{2022-23}{\textnormal{Workshops on Bayesian linear models and GAMMs at different institutions.}}{}{}
	\entry{2021}{intRo: Data visualisation with R}{\url{https://intro-rstats.github.io}}{Online workshop, sponsored by Engage @ Liverpool and Methods North West}
	\entry{2021}{learnB4SS: Learn Bayesian Analysis for Speech Sciences}{\url{https://learnb4ss.github.io}}{Workshop given on-line with Timo Roettger and Joseph V. Casillas, supported by LabPhon}
	\entry{2018}{An introduction to GAM(M)s}{\url{https://github.com/stefanocoretta/gamm-workshop}}{Workshop given at Aarhus University, Denmark}
\end{entrylist}
...
\begin{entrylist}
	% \entry
	% 	{2020-2021}
	% 	{\textnormal{Postdoctoral researcher for the ERC project \textit{Human interaction and the evolution of spoken accent} (PI Jonathan Harrington)}}
	% 	{}
	% 	{}
	% \entry
	% 	{2019-2020}
	% 	{\textnormal{Postdoctoral researcher for the DFG project \textit{Nasal coarticulation and sound-change: a real-time MRI study} (PI Phil Hoole)}}
	% 	{}
	% 	{}
	\entry
		{2018--2019}
